//! Semantic code search: canonical function-document embeddings plus git co-edit
//! relevance, returned as independent retrieval signals. Reranking happens
...
//! localizer prototype; see `analysis/coedit-reranker/REPORT.md` there for the
//! sweeps that selected these values.
