...
pub use ir::{
    ...
    QueryValueKind, ReachingBindingOptions, ReceiverTraversalFilter, ReferenceTraversalFilter,
    SCHEMA_VERSION, ScopeFilter, ScopeSeed, SegmentsOfOptions, SetOperator, StringPredicate,
