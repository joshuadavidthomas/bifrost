...
pub fn rust_source_contains_tests(root: Node<'_>, source: &str) -> bool {
    let mut found = false;
...
pub fn rust_attribute_is_test_evidence(attribute_item: Node<'_>, source: &str) -> bool {
...
pub fn detect_rust_test_assertion_smells(
    file: &ProjectFile,
    source: &str,
