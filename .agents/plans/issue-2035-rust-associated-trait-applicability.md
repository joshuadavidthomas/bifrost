...
- [x] (2026-08-14 01:39Z) Published the correction and evidence through `79e511ccf`, closed #2035 again with both clean witnesses, and verified the issue state is closed.
...
The implementation and its target-complete regression correction are published and fully validated. Argument applicability separates exact trait implementations without suppressing enum-variant constructors; both production families have clean, consistent, exact inverse evidence. #2035 is closed.
...
Plan revision, 2026-08-14: Published the regression correction and evidence through `79e511ccf`; GitHub issue #2035 was closed again at `2026-08-14T01:39:08Z`.
