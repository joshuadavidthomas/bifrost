...
Java and Python remain. Historical fixes and issue closures in those languages remain regression inputs only until their task-ranked repository sets receive the same exhaustive current-head publication treatment.
