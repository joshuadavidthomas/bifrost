...
query_step_ops! {
    ...
    ReceiverTargets { label: "receiver_targets", signature: "structural_match|reference_site|call_site|expression_site -> receiver_analysis", description: "Analyze a bounded receiver value at each supported-language input site." }
    PointsTo { label: "points_to", signature: "structural_match|reference_site|expression_site -> receiver_analysis", description: "Analyze bounded value provenance for each supported-language input expression." }
    MemberTargets { label: "member_targets", signature: "structural_match|reference_site -> receiver_analysis", description: "Resolve exact member declarations through bounded supported-language receiver facts." }
}
...
rql_forms! {
    ...
    ReceiverTargets {
        ...
        description: "Analyze bounded receiver values at supported structural or semantic source sites.",
    }
    PointsTo {
        ...
        description: "Analyze bounded value and allocation provenance at supported source expressions.",
    }
    MemberTargets {
        ...
        description: "Resolve exact member declarations through a supported analyzed receiver.",
    }
    Name {
        labels: ["name"],
        class: Predicate,
